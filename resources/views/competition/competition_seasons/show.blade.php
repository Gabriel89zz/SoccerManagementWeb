        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-link me-2"></i> Association Details
                    </h5>
                    <div>
                        <a href="{{ route('competition-seasons.edit', $competitionSeason->competition_season_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('competition-seasons.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <p class="fs-5">{{ $competitionSeason->competition->name ?? 'Unknown' }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Season</label>
                            <p class="fs-5">
                                @if($competitionSeason->season)
                                    <span class="badge bg-info text-dark">{{ $competitionSeason->season->name }}</span>
                                @else
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $competitionSeason->competition_season_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="small text-muted fw-bold">Status</label>
                            <div>
                                @if($competitionSeason->is_active)
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $competitionSeason->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $competitionSeason->created_at ? $competitionSeason->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $competitionSeason->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($competitionSeason->updated_at)
                                        {{ $competitionSeason->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $competitionSeason->deletedBy->username ?? '-' }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($competitionSeason->deleted_at)
                                        {{ $competitionSeason->deleted_at->format('d M Y, H:i') }}
                                    @else
