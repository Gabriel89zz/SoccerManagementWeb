        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-layer-group me-2"></i> Stage Details: {{ $stage->name }}
                    </h5>
                    <div>
                        <a href="{{ route('competition-stages.edit', $stage->stage_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('competition-stages.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Stage Name</label>
                            <p class="fs-5">{{ $stage->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Sequence Order</label>
                            <p class="fs-5">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="fs-5">
                                @if($stage->competitionSeason && $stage->competitionSeason->season)
                                    <span class="badge bg-info text-dark">{{ $stage->competitionSeason->season->name }}</span>
                                @else
                                    <span class="text-muted">N/A</span>
                                @endif
                            </p>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $stage->stage_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $stage->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $stage->created_at ? $stage->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">
                                    @if($stage->updated_at)
                                        {{ $stage->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($stage->deleted_at)
                                        {{ $stage->deleted_at->format('d M Y, H:i') }}
                                    @else
