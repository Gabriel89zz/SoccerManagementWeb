        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-trophy me-2"></i> Competition Details: {{ $competition->name }}
                    </h5>
                    <div>
                        <a href="{{ route('competitions.edit', $competition->competition_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('competitions.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Competition Name</label>
                            <p class="fs-5">{{ $competition->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Type</label>
                            <p class="fs-5">
                                @if($competition->type)
                                    {{-- CORRECCIÓN: type_name en lugar de name --}}
                                    <span class="badge bg-secondary">{{ $competition->type->type_name }}</span>
                                @else
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Country (National)</label>
                            <p class="fs-5">
                        ...
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Confederation (Continental)</label>
                            <p class="fs-5">
                                @if($competition->confederation)
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $competition->competition_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $competition->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $competition->created_at ? $competition->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $competition->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($competition->updated_at)
                                        {{ $competition->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $competition->deletedBy->username ?? '-' }}
                            </div>
                        </div>
