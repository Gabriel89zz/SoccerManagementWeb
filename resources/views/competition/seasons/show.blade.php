        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-calendar-alt me-2"></i> Season Details: {{ $season->name }}
                    </h5>
                    <div>
                        <a href="{{ route('seasons.edit', $season->season_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('seasons.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Season Name</label>
                            <p class="fs-5">{{ $season->name }}</p>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $season->season_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $season->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $season->created_at ? $season->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $season->editor->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($season->updated_at)
                                        {{ $season->updated_at->format('d M Y, H:i') }}
                                    @else
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($season->deleted_at)
                                        {{ $season->deleted_at->format('d M Y, H:i') }}
                                    @else
