        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-trophy me-2"></i> Award Details: {{ $award->name }}
                    </h5>
                    <div>
                        <a href="{{ route('awards.edit', $award->award_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('awards.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Award Name</label>
                            <p class="fs-5">{{ $award->name }}</p>
                        </div>
                        <div class="col-md-8">
                            <label class="fw-bold text-muted small">Description</label>
                            <p class="fs-5">{{ $award->description ?? 'No description provided.' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $award->award_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $award->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $award->created_at->format('d M Y, H:i') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $award->editor->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($award->updated_at)
                                        {{ $award->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($award->deleted_at)
                                        {{ $award->deleted_at->format('d M Y, H:i') }}
                                    @else
