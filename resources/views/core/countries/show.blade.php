        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-globe-americas me-2"></i> Country Details: {{ $country->name }}
                    </h5>
                    <div>
                        <a href="{{ route('countries.edit', $country->country_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('countries.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Country Name</label>
                            <p class="fs-5">
                                <i class="fas fa-flag me-2 text-secondary"></i>{{ $country->name }}
                            </p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">ISO Code</label>
                            <p class="fs-5"><span class="badge bg-secondary">{{ $country->iso_code }}</span></p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $country->country_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $country->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $country->created_at->format('d M Y, H:i') }}</span>
                            </div>
                        </div>
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($country->deleted_at)
                                        {{ $country->deleted_at->format('d M Y, H:i') }}
                                    @else
