        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-clipboard-list me-2"></i> Formation Details: {{ $formation->name }}
                    </h5>
                    <div>
                        <a href="{{ route('formations.edit', $formation->formation_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('formations.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Formation Name</label>
                            <p class="fs-5">{{ $formation->name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $formation->formation_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $formation->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $formation->created_at ? $formation->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $formation->editor->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($formation->updated_at)
                                        {{ $formation->updated_at->format('d M Y, H:i') }}
                                    @else
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($formation->deleted_at)
                                        {{ $formation->deleted_at->format('d M Y, H:i') }}
                                    @else
