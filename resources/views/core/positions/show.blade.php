        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-running me-2"></i> Position Details: {{ $position->name }}
                    </h5>
                    <div>
                        <a href="{{ route('positions.edit', $position->position_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('positions.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <p class="fs-5">{{ $position->name }}</p>
                        </div>
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Acronym</label>
                            <p class="fs-5"><span class="badge bg-secondary">{{ $position->acronym }}</span></p>
                        </div>
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Category</label>
                            <p class="fs-5">{{ $position->category }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $position->position_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $position->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $position->created_at ? $position->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
