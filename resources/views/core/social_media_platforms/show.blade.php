        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-share-alt me-2"></i> Platform Details: {{ $platform->name }}
                    </h5>
                    <div>
                        <a href="{{ route('social-media-platforms.edit', $platform->social_media_platform_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('social-media-platforms.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $platform->social_media_platform_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $platform->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $platform->created_at ? $platform->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $platform->editor->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($platform->updated_at)
                                        {{ $platform->editor->format('d M Y, H:i') }}
                                    @else
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($platform->deleted_at)
                                        {{ $platform->deleted_at->format('d M Y, H:i') }}
                                    @else
