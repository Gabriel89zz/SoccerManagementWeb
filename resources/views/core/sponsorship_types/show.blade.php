        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-handshake me-2"></i> Sponsorship Type Details: {{ $type->type_name }}
                    </h5>
                    <div>
                        <a href="{{ route('sponsorship-types.edit', $type->sponsorship_type_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('sponsorship-types.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Type Name</label>
                            <p class="fs-5">{{ $type->type_name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $type->sponsorship_type_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $type->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $type->created_at ? $type->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
