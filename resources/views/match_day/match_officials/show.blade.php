        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-user-shield me-2"></i> Assignment Details: {{ $official->role }}
                    </h5>
                    <div>
                        <a href="{{ route('match-officials.edit', $official->match_official_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('match-officials.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <h6 class="text-primary border-bottom pb-2"><i class="fas fa-info-circle me-2"></i>Official Information</h6>
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Referee Name</label>
                            <p class="fs-5">{{ $official->referee->full_name ?? 'Unknown' }}</p>
                        </div>
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Certification</label>
                            <p class="fs-5">{{ $official->referee->certification_level ?? 'N/A' }}</p>
                        </div>
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Assigned Role</label>
                            <p class="fs-5">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <p class="fs-6">
                                @if($official->match)
                                    {{ $official->match->homeTeam->name ?? '?' }} <span class="text-muted">vs</span> {{ $official->match->awayTeam->name ?? '?' }}
                                    <br>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $official->match_official_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $official->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $official->created_at ? $official->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $official->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($official->updated_at)
                                        {{ $official->updated_at->format('d M Y, H:i') }}
                                    @else
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($official->deleted_at)
                                        {{ $official->deleted_at->format('d M Y, H:i') }}
                                    @else
