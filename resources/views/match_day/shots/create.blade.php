...
<div class="card shadow" style="max-width: 900px; margin: 0 auto;">
    <div class="card-header bg-primary text-white"><h5 class="mb-0">Register New Shot</h5></div>
    <div class="card-body">
        ...
        <form action="{{ route('shots.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="minute" class="form-control" required min="1" max="130" placeholder="Ex: 23">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <!-- FIX: Inputs hidden para enviar '0' si no se marcan -->
                    <div class="form-check">
                        <input type="hidden" name="is_on_target" value="0">
                        <input class="form-check-input" type="checkbox" id="is_on_target" name="is_on_target" value="1">
                        <label class="form-check-label" for="is_on_target">Is On Target?</label>
                    </div>
                    
                    <div class="form-check mt-2">
                        <input type="hidden" name="is_goal" value="0">
                        <input class="form-check-input" type="checkbox" id="is_goal" name="is_goal" value="1">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" name="location_x" class="form-control" placeholder="X" step="0.01">
                        <input type="number" name="location_y" class="form-control" placeholder="Y" step="0.01">
                    </div>
                </div>
            </div>
            ...
            <div class="text-end mt-4">
                ...
                <button type="submit" class="btn btn-success">Save Shot</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $('#team_id').on('change', function() {
            // Lógica de filtro adicional si se requiere
        });
    });
</script>
@endsection