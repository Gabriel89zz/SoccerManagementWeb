        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-school me-2"></i> Academy Details: {{ $academy->name }}
                    </h5>
                    <div>
                        <a href="{{ route('academies.edit', $academy->academy_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('academies.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Academy Name</label>
                            <p class="fs-5">{{ $academy->name }}</p>
                        </div>
                        <div class="col-md-3">
                            <label class="fw-bold text-muted small">Parent Team</label>
                            <p class="fs-5">
                                @if($academy->team)
                                    <span class="badge bg-secondary">{{ $academy->team->name }}</span>
                                @else
                        ...
                        <div class="col-md-3">
                            ...
                            <p class="fs-5">
                                @if($academy->city)
                                    {{ $academy->city->name }}
                                    @if($academy->city->country)
                                        <br>
                                        <span class="small text-muted"><i class="fas fa-flag me-1"></i> {{ $academy->city->country->name }}</span>
                                    @endif
                                @else
                                    <span class="text-muted small">Not Assigned</span>
                                @endif
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $academy->academy_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $academy->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $academy->created_at ? $academy->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $academy->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($academy->updated_at)
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($academy->deleted_at)
                                        {{ $academy->deleted_at->format('d M Y, H:i') }}
                                    @else
