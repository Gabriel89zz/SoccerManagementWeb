        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-briefcase me-2"></i> Agency Details: {{ $agency->name }}
                    </h5>
                    <div>
                        <a href="{{ route('agencies.edit', $agency->agency_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('agencies.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Agency Name</label>
                            <p class="fs-5">{{ $agency->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Country</label>
                            <p class="fs-5">
                                @if($agency->country)
                                    <i class="fas fa-flag me-1 text-muted"></i> {{ $agency->country->name }}
                                @else
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $agency->agency_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $agency->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $agency->created_at ? $agency->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($agency->deleted_at)
                                        {{ $agency->deleted_at->format('d M Y, H:i') }}
                                    @else
