        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-hand-holding-usd me-2"></i> Sponsor Details: {{ $sponsor->name }}
                    </h5>
                    <div>
                        <a href="{{ route('sponsors.edit', $sponsor->sponsor_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('sponsors.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Sponsor Name</label>
                            <p class="fs-5">{{ $sponsor->name }}</p>
                        </div>
                        <div class="col-md-4">
                            <label class="fw-bold text-muted small">Industry</label>
                            <p class="fs-5">
                                @if($sponsor->industry)
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="fs-5">
                                @if($sponsor->country)
                                    <i class="fas fa-flag me-1 text-muted"></i> {{ $sponsor->country->name }}
                                @else
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $sponsor->sponsor_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $sponsor->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $sponsor->created_at ? $sponsor->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
