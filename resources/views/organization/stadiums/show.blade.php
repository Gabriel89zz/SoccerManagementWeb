        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-landmark me-2"></i> Stadium Details: {{ $stadium->name }}
                    </h5>
                    <div>
                        <a href="{{ route('stadiums.edit', $stadium->stadium_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('stadiums.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Stadium Name</label>
                            <p class="fs-5">{{ $stadium->name }}</p>
                        </div>
                        <div class="col-md-3">
                            <label class="fw-bold text-muted small">Capacity</label>
                            <p class="fs-5">
                                @if($stadium->capacity)
                                    <i class="fas fa-users me-1 text-muted"></i> {{ number_format($stadium->capacity) }}
                                @else
                            ...
                            <p class="fs-5">
                                @if($stadium->city)
                                    ...
                                    @if($stadium->city->country)
                                        <br>
                                        <span class="small text-muted"><i class="fas fa-flag me-1"></i> {{ $stadium->city->country->name }}</span>
                                    @endif
                                @else
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $stadium->stadium_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $stadium->creator->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $stadium->created_at ? $stadium->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $stadium->editor->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($stadium->updated_at)
                                        {{ $stadium->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($stadium->deleted_at)
                                        {{ $stadium->deleted_at->format('d M Y, H:i') }}
                                    @else
