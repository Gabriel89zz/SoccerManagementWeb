        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-file-contract me-2"></i> Sponsorship Deal Details
                    </h5>
                    <div>
                        <a href="{{ route('team-sponsorships.edit', $contract->team_sponsorship_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('team-sponsorships.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <p class="fs-5">{{ $contract->team->name ?? 'Unknown Team' }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Sponsor</label>
                            <p class="fs-5">{{ $contract->sponsor->name ?? 'Unknown Sponsor' }}</p>
                        </div>
                    </div>
                    
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Sponsorship Type</label>
                            <p class="fs-5">
                                @if($contract->sponsorshipType)
                                    <span class="badge bg-secondary">{{ $contract->sponsorshipType->type_name }}</span>
                                @else
                        ...
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Deal Value</label>
                            <p class="fs-5 text-success font-monospace">
                                € {{ number_format($contract->deal_value_eur, 2) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $contract->team_sponsorship_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $contract->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $contract->created_at ? $contract->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($contract->deleted_at)
                                        {{ $contract->deleted_at->format('d M Y, H:i') }}
                                    @else
