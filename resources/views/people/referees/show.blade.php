        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-gavel me-2"></i> Referee Details: {{ $referee->first_name }} {{ $referee->last_name }}
                    </h5>
                    <div>
                        <a href="{{ route('referees.edit', $referee->referee_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('referees.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <p class="fs-5">{{ $referee->first_name }} {{ $referee->last_name }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Date of Birth</label>
                            <p class="fs-5">
                                {{ \Carbon\Carbon::parse($referee->date_of_birth)->format('d M, Y') }}
                                <span class="badge bg-light text-dark ms-2 border">Age: {{ \Carbon\Carbon::parse($referee->date_of_birth)->age }}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <p class="fs-5">
                                @if($referee->country)
                                    <i class="fas fa-flag me-1 text-muted"></i> {{ $referee->country->name }}
                                @else
                        ...
                        <div class="col-md-6">
                            <label class="fw-bold text-muted small">Certification Level</label>
                            <p class="fs-5">
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $referee->referee_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $referee->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $referee->created_at ? $referee->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $referee->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($referee->updated_at)
                                        {{ $referee->updated_at->format('d M Y, H:i') }}
                                    @else
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($referee->deleted_at)
                                        {{ $referee->deleted_at->format('d M Y, H:i') }}
                                    @else
