...
<div class="card shadow" style="max-width: 800px; margin: 0 auto;">
    <div class="card-header bg-primary text-white"><h5 class="mb-0">New Scout Profile</h5></div>
    <div class="card-body">
        <form action="{{ route('scouts.store') }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="first_name" class="form-control" required placeholder="Ex: Juni">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Last Name</label>
                    <input type="text" name="last_name" class="form-control" required placeholder="Ex: Calafat">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="region" class="form-control" placeholder="Ex: South America, Europe">
                </div>
                <div class="col-md-6">
            ...
            <div class="text-end mt-4">
                ...
                <button type="submit" class="btn btn-success">Save Scout</button>
            </div>
        </form>
    </div>
</div>
