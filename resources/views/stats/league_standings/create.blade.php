...
<div class="card shadow" style="max-width: 900px; margin: 0 auto;">
    <div class="card-header bg-primary text-white"><h5 class="mb-0">Add League Standing Record</h5></div>
    <div class="card-body">
        ...
        <form action="{{ route('league-standings.store') }}" method="POST">
            @csrf
            
            <!-- SECCIÓN 1: CONTEXTO -->
            <h6 class="text-primary mb-3"><i class="fas fa-table me-2"></i>League & Team</h6>
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label">Competition Season</label>
                    <select name="competition_season_id" class="form-select select2-search" required data-placeholder="Select League Season">
                        <option value=""></option>
            ...
            <div class="text-end mt-4">
                <a href="{{ route('league-standings.index') }}" class="btn btn-secondary me-2">Cancel</a>
