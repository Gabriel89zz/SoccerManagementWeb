        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-table me-2"></i> Standing Details
                    </h5>
                    <div>
                        <a href="{{ route('league-standings.edit', $standing->league_standing_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('league-standings.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="fs-5">
                                @if($standing->competitionSeason && $standing->competitionSeason->competition)
                                    {{ $standing->competitionSeason->competition->name }}
                                @else
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="fs-5">
                                @if($standing->competitionSeason && $standing->competitionSeason->season)
                                    <span class="badge bg-info text-dark">{{ $standing->competitionSeason->season->name }}</span>
                                @else
                                    <span class="text-muted">N/A</span>
                                @endif
                            </p>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $standing->league_standing_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
