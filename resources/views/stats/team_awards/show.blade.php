        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-trophy me-2"></i> Award Details
                    </h5>
                    <div>
                        <a href="{{ route('team-awards.edit', $teamAward->team_award_id) }}" class="btn btn-light btn-sm fw-bold text-dark">
                            <i class="fas fa-edit me-1"></i> Edit
                        </a>
                        <a href="{{ route('team-awards.index') }}" class="btn btn-light btn-sm fw-bold text-dark ms-2">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="fs-5">
                                <span class="badge bg-info text-dark">
                                    {{ $teamAward->season->name ?? 'Unknown Season' }}
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row bg-light p-3 rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="fs-6">{{ $teamAward->team_award_id }}</div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="small text-muted fw-bold">Status</label>
                            <div>
                                @if($teamAward->is_active)
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                {{ $teamAward->createdBy->username ?? 'System' }}
                                <br>
                                <span class="text-muted small">{{ $teamAward->created_at ? $teamAward->created_at->format('d M Y, H:i') : '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                ...
                                {{ $teamAward->updatedBy->username ?? '-' }}
                                <br>
                                <span class="text-muted small">
                                    @if($teamAward->updated_at)
                                        {{ $teamAward->updated_at->format('d M Y, H:i') }}
                                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <span class="text-muted small">
                                    @if($teamAward->deleted_at)
                                        {{ $teamAward->deleted_at->format('d M Y, H:i') }}
                                    @else
